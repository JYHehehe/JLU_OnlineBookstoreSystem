...
public class Goods_service {
    ...
    public int add_goods(Goods goods){
        return goods_mapper.add_goods(goods);
    }

    public int modify_goods(Goods goods){
        return goods_mapper.modify_goods(goods);
    }

    public int set_goods_view(String goods_id,String view_address){
        return goods_mapper.set_goods_view(goods_id,view_address);
    }
